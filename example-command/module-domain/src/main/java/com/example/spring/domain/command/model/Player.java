...
import com.example.spring.domain.command.PlayerHasNoTeamException;
import com.example.spring.domain.command.PlayerInvalidPointException;
...
public class Player {
    ...
    public Player addPoint(PlayerAddPointCommand command) {
