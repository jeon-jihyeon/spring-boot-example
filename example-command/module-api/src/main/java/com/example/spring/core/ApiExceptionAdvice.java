...
public class ApiExceptionAdvice {
    ...
    public ResponseEntity<ResponseModel<?>> handleApiException(BaseException e) {
        switch (e.getCode().getLogLevel()) {
        ...
        return ResponseEntity.status(e.getCode().getStatus()).body(ResponseModel.error(e));
    }
