...
public interface AcquisitionContract {
    /**
     * 지정된 심볼과 통화에 대한 시간 단위 캔들 데이터를 조회
     *
     * <p>반환되는 데이터 타입:
     * <ul>
     ...
     * @return 수집된 데이터
     * <ul>
     *   <li>{@link AcquisitionCandleResponse} 목록</li>
     * </ul>
     ...
     */
    List<AcquisitionCandleResponse> findAcquisitionCandles(AcquisitionCandlesRequest request);
}
